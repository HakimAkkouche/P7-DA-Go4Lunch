...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    private final MutableLiveData<Location> currentLocation = SharedDataMVVM.getInstance().getCurrentLocationMutableLiveData();
    ...
    private void initAutocompleteFragment() {
        ...
        if(autocompleteFragment != null) {
            ...
            mapViewModel.getCurrentLocation().observe(getViewLifecycleOwner(), location -> autocompleteFragment.setLocationRestriction(RectangularBounds.newInstance(
