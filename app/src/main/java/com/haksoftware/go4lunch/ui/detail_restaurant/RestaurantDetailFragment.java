...
public class RestaurantDetailFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        restaurantDetailViewModel.getRestaurantColleagues(clickedRestaurant).observe(getViewLifecycleOwner(), restaurantParticipantsListAdapter::submitList);
    ...
    private void initDetailRestaurant() {
        ...
        binding.isTodayChosenRestFloatingBtn.setOnClickListener(view -> {
            ...
            restaurantDetailViewModel.getSelectedRestaurant().observe(getViewLifecycleOwner(), selectedRestaurant -> {
                if (selectedRestaurant != null && selectedRestaurant.getRestaurantId().equals(clickedRestaurant.getRestaurantId())) {
                    ...
                    if (listener != null) {
                        listener.onRestaurantSelectedClick(null);
                    }
                } else {
                    ...
                    if (listener != null) {
                        listener.onRestaurantSelectedClick(clickedRestaurant);
                    }
                }
                updateChosenButtonColor();
            });
        ...
        binding.likeButton.setOnClickListener(view -> restaurantDetailViewModel.getLikedRestaurant(clickedRestaurant.getRestaurantId()).observe(getViewLifecycleOwner(), documentSnapshot -> {
        ...
        restaurantDetailViewModel.getLikedRestaurant(clickedRestaurant.getRestaurantId()).observe(getViewLifecycleOwner(), documentSnapshot -> {
            isLikedRestaurant = documentSnapshot != null;
            updateLikeButtonColor();
        });
    }
