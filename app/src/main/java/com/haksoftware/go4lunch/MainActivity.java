...
import com.haksoftware.go4lunch.ui.OnProfileUpdateListener;
...
public class MainActivity extends AppCompatActivity implements LifecycleOwner, OnProfileUpdateListener, RestaurantSelectedClickedListener {
    ...
    @Override
    public void onRestaurantSelectedClick(Restaurant restaurant) {
